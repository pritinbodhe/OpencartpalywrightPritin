...
const jsonRawData = DataProvider.getTestDataFromJson(jsonPath);
const jsonTestData: { testName: string; email: string; password: string; expected: string }[] =
  typeof jsonRawData === "string" ? JSON.parse(jsonRawData) : jsonRawData;
...
const csvTestData = DataProvider.getTestDataFromCSV(csvPath) as { testName: string; email: string; password: string; expected: string }[];
